...
//--- declare event-level variables
  EventInfo eventInfo(isSignal, true, false);
...
//--- declare histograms
  ...
  {
    MEMbbwwHistManagerDilepton* mem_genuineLeadingBJet_genuineSubleadingBJet_;
    MEMbbwwHistManagerDilepton* mem_genuineLeadingBJet_fakeSubleadingBJet_;
    MEMbbwwHistManagerDilepton* mem_fakeLeadingBJet_genuineSubleadingBJet_;
    MEMbbwwHistManagerDilepton* mem_fakeLeadingBJet_fakeSubleadingBJet_;
  ...
  selHistManager->mem_genuineLeadingBJet_genuineSubleadingBJet_ = new MEMbbwwHistManagerDilepton(makeHistManager_cfg(process_string,
    Form("%s/sel/mem_genuineLeadingBJet_genuineSubleadingBJet", histogramDir.data()), era_string, central_or_shift));
  selHistManager->mem_genuineLeadingBJet_genuineSubleadingBJet_->bookHistograms(fs);
  selHistManager->mem_genuineLeadingBJet_fakeSubleadingBJet_ = new MEMbbwwHistManagerDilepton(makeHistManager_cfg(process_string,
    Form("%s/sel/mem_genuineLeadingBJet_fakeSubleadingBJet", histogramDir.data()), era_string, central_or_shift));
  selHistManager->mem_genuineLeadingBJet_fakeSubleadingBJet_->bookHistograms(fs);
  selHistManager->mem_fakeLeadingBJet_genuineSubleadingBJet_ = new MEMbbwwHistManagerDilepton(makeHistManager_cfg(process_string,
    Form("%s/sel/mem_fakeLeadingBJet_genuineSubleadingBJet", histogramDir.data()), era_string, central_or_shift));
  selHistManager->mem_fakeLeadingBJet_genuineSubleadingBJet_->bookHistograms(fs);
  selHistManager->mem_fakeLeadingBJet_fakeSubleadingBJet_ = new MEMbbwwHistManagerDilepton(makeHistManager_cfg(process_string,
    Form("%s/sel/mem_fakeLeadingBJet_fakeSubleadingBJet", histogramDir.data()), era_string, central_or_shift));
  selHistManager->mem_fakeLeadingBJet_fakeSubleadingBJet_->bookHistograms(fs);
...
//--- apply pT smearing to generator-level b-jets (and other jets)
	...
	int idxGenJet = TMath::Nint(rnd.Uniform(-0.5, selGenJets.size() - 0.5));
...
//--- apply pX, pY smearing to generator-level missing transverse momentum (MET)
    ...
    } else if ( selGenBJet_sublead_isFake ) {
      selHistManager->mem_genuineLeadingBJet_fakeSubleadingBJet_->fillHistograms(memResult, memCpuTime, evtWeight);
    } else {
